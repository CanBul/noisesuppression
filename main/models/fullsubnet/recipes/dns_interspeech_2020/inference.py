...
if __name__ == "__main__":
    ...
    parser.add_argument("-D", "--dataset_dir", type=str, required=True, help="The path for saving enhanced speeches.")
    args = parser.parse_args()

    config_path = Path(args.configuration).expanduser().absolute()
    configuration = toml.load(config_path.as_posix())
    configuration['dataset']['args']['dataset_dir_list'] = [args.dataset_dir]
